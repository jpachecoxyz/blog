...
#+date: 2024-07-04
#+tags: emacs(e) blog(b) post(p) project(P) linux(l) tecnology(t) wayland(w) script(s) work(w) personal(r)
...
* DONE Screen Record                                      :post:linux:script:
...
* DONE Efetch.el                                          :emacs:post:script:
...
* DONE Void linux bootstrap.                 :project:linux:tecnology:script:
:PROPERTIES:
...
* DONE Shell-utils                                     :project:linux:script:
:PROPERTIES:
...
* DONE Pymetrics                            :project:linux:tecnology:wayland:
...
* DONE Emacs vs Neovim                   :emacs:blog:post:tecnology:personal:
...
* DONE How I made my blog with emacs and hugo :emacs:blog:tecnology:personal:
...
* DONE Install Telega in NixOS - Emacs.          :emacs:post:linux:tecnology:
